...
<section id="source-tarball" class="primary inverted">
  <div class="wrapper">
    ...
    <p>To build Haguichi from source download the <a href="https://launchpad.net/haguichi/1.5/1.5.3/+download/haguichi-1.5.3.tar.xz" target="_blank">source tarball</a> and extract it. Open the text file named <b>INSTALL.md</b> and follow the instructions within.</p>
  </div>
</section>
